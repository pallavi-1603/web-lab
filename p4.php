        ...
        <section>
            <div class="container">
                <div class="row">
                    <div class="col1">
                        <div class="product">
                        <img src="img/m4.jpg" alt="product" width="100%">
                    
                    <div class="col2">
                        <h1>Xiaomi 12 Pro 5G</h1>
                        <h4>INR 59999 Rupees</h4>
                        <br>
                        <h3>Product Details</h3>
                        <p>
                            <ul>
                                <li>Brightest Display</li>
                                <li>Superfast 50W Wireless Charging</li>
                                <li>Solid Build Quality</li>
                                <li>Great camera Implementation</li>
